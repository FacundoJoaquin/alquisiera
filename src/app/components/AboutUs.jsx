    ...
    return (
        <section className=" w-full flex h-max mb-8 xs:flex-col tb:flex-col tb:items-center">
            ...
            <div className="w-2/3 flex flex-col gap-y-2 px-16 mt-10 xs:w-full xs:px-2 xs:gap-y-4 tb:w-full tb:px-2 tb:gap-y-4">
                ...
                <p className="text-xl">
                    ¡Hola! Nosotros <span className="text-strongMainBlue font-semibold">somos Facu e Indi</span>, una pareja que <span className="text-strongMainBlue font-semibold">busca mezclar el arte de la ilustración con la magia del desarrollo web</span> para crear algo especial.

                </p>
                <p className="text-xl">
                    Cada detalle en nuestro proyecto ha sido cuidadosamente diseñado con amor y dedicación. <span className="text-strongMainBlue font-semibold">Nuestra meta es ofrecer una plataforma útil para aquellos que buscan un hogar donde vivir.</span>

                </p>
                <p className="text-xl">
                    Es así como nace <span className="text-strongMainBlue font-semibold">Alquisiera</span>, una creación que refleja nuestras pasiones y está <span className="text-strongMainBlue font-semibold">destinada a ayudar a las personas a encontrar su hogar perfecto</span>.
                    Si nuestro trabajo te interesó y estás considerando una colaboración futura, ¡nos encantaría escuchar tu idea!
                </p>

                <div className="text-xl">
                    A continuación, te dejamos nuestros datos de contacto por si estás interesado en trabajar juntos o con alguno de nosotros.
                </div>
